...
#### 1.1 Origen de la investigacion
...
los datos de toda la provincia de MÁlaga pero vamos a comprobar que en promoedio tenemos datos representativos de 
todas las ciudades. 
...
para esa localidad. O al menos ser mas ciudadosos. 
...
Esta duda metodológica es plausible si tenemos en cuenta que las estacoines pueden fallar por culpa de problemas tecnicos
...
que corresponde a "Antequera Ayuntamiento". En un principio se barajo la posibilidad de que la falta de registros podria 
...
que filtra la radiación solar es más delgada y por lo tanto hay menos condensacino del calor en las zonas de mayor altura, 
...
que tenga una altitud baja y ademas que tenga picos de temperatrua maxima. No olvidemos que la temepratrua media
...
### 5. Prediciones
#### 5.1 Proceso de imputacion de datos
...
#### 5.3 Analisis importancia variables
...
ciberseguirdad de tan bonitas ciudades. Lo que si muestra esta investigacion es la importancia de disponer 
